...
이미 정해진 "썰"을 받아서 25초 쇼츠 대본 (5씬 × 5초)으로 각색하는 일만 합니다.
...
3. 앵글을 한 번에 다 말하지 말고 **반전 구조**로 풀기:
   ...
   - 씬 3: 반전 포인트 (팩트의 핵심)
   - 씬 4: 부연 설명 / 충격 정보
   - 씬 5: 여운 있는 마무리 (조용한 종결)
4. 각 씬 **40~70자** (TTS로 5초에 읽히는 자연 분량)
5. 구어체 내레이션/혼잣말. 과도한 마케팅 톤 금지.
6. 제품명은 **0~1번만** 언급 (훅에 이미 있으면 본문에는 안 넣어도 됨)
7. "좋다/편하다/후회 안 해요" 같은 평가어 금지. CTA 금지.

## 출력 JSON

- storyPremise: 이 쇼츠의 시청자 경험을 2~3줄로 (팩트를 어떻게 풀지)
- newScenes: **정확히 5씬** (index 0~4, durationSec 5, emotion 1단어, text 40~70자)`;
}
